...
const Home = () => {
  ...
  useEffect(() => {
    ...
    async function getHighRatedProducts() {
      try {
        const res = await axios.get(`/api/v1/products/high-rated`)
    ...
    async function newArrivalProducts() {
      try {
        const res = await axios.get(`/api/v1/products/new-arrival`)
    ...
    async function bestDealProducts() {
      try {
        const res = await axios.get(`/api/v1/products/best-deal`)
