...
const CategoryCard = ({ category }) => {
  return (
    <Link to={`/category/${category.title}`} className='w-[45vw] h-[170px] md:w-[150px] md:h-[150px] bg-white shadow py-2 flex items-center justify-center flex-col rounded overflow-hidden hover:shadow-xl'>
