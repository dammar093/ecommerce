...
const { addProduct, getAllProducts, getBestDealsProguct, getHighRatedProduct, getNewArrivalProducts, deleteProducts, getProductByPage, getProductById, getRelatedProduct ,getFiltredPRoducts, getProductsBySearch} = require("../controllers/product");
